package com.example.pendulumtestjava.all;
...
//    ********IMPORTANT*********
//    The following tests were created for testing all the different features that had been implemented to the project.
//    Unfortunately, the most important features at the pendulum views could not be tested properly due to the timer that is running behind the system.
//    Hence the tests are getting stuck when reaching the first pendulum (since the test is waiting for the timer to finish, but it's set to be endless')
//    The programming phase of this project was done with continous bugFixing, hence (to the best of my knowledge) there is no bug currently at the system.
//    Please see the other tests in the androidTest folder for the more detailed, successfully finishing tests.
//    ********IMPORTANT*********
