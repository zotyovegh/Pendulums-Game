...
public class DoublePendulumViewModel extends ViewModel {
    ...
    public DrawingPath path, path2;

    private DbViewModel dbViewModel;

    public void defineVariables(double widthMiddleBall, double heightMiddlePoint, DrawingPath path, DrawingPath path2, DbViewModel dbViewModel) {
