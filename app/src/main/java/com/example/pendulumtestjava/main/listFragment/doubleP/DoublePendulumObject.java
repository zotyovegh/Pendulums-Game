...
@Entity(tableName = "double_pendulum_table")
public class DoublePendulumObject {
    ...
    public DoublePendulumObject(double a1, double a2, double r1,
                                double r2, double g, double m1,
                                double m2, int trace1, int trace2,
                                int traceColor1, int traceColor2,
                                int ballColor1, int ballColor2,
                                String points1Json, String points2Json,
                                String timeStamp, boolean endlessTrace1,
                                boolean endlessTrace2, boolean isTrace1On,
                                boolean isTrace2On) {
        this.a1 = a1;
        this.a2 = a2;
        this.r1 = r1;
